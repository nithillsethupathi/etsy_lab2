      ...
      <div className="flex min-h-full flex-col items-center">
        <nav className="mx-[20%] flex justify-center p-4">
          <div className="w-[150%] flex flex-shrink-0">
            ...
            <button onClick={()=> navigate('/cart')} type="submit" className="w-[15%] mx-auto flex justify-center items-center rounded-full border-white hover:bg-gray-200">
